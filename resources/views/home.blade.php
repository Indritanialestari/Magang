...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {{-- Card untuk Histori Perubahan --}}
        <div class="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center justify-between transform transition-transform duration-300 hover:scale-105 hover:shadow-xl border border-gray-200">
            <div class="text-6xl mb-6 text-gray-600">🗂️</div>
            <h2 class="text-2xl font-bold text-gray-800 mb-4 text-center">Histori Perubahan</h2>
            <p class="text-lg text-gray-600 mb-8 text-center">Lihat semua rekam jejak perubahan data karyawan.</p>
            <a href="{{ route('histori.index') }}" class="w-full text-center bg-gray-600 hover:bg-gray-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-75">
                Lihat Histori
                <span class="ml-2">→</span>
            </a>
        </div>
